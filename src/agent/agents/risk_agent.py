...
1. **Insider / Major Shareholder Activity** — sell-downs (減持), pledges
2. **Earnings Warnings** — pre-loss, downward revisions (業績預虧, 業績變臉)
3. **Regulatory** — penalties, investigations, violations (監管處罰, 立案調查)
